#############################################################################
# Makefile for building: Horaris-FIB.exe
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = Horaris-FIB.exe1.0.0
DISTDIR = /home/jon/Desktop/code/Horaris-FIB/.tmp/Horaris-FIB.exe1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1
